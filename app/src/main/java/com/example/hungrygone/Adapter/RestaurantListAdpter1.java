...
public class RestaurantListAdpter1 extends RecyclerView.Adapter<RestaurantListAdpter1.MyViewHolder> {
    private final Context context;
    private final ArrayList<RestaurantListModel> restaurantModelArrayList;

    public RestaurantListAdpter1(Context context, ArrayList<RestaurantListModel> restaurantModelArrayList) {
    ...
    @NonNull
    @Override
    public RestaurantListAdpter1.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.restaurant_model, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RestaurantListAdpter1.MyViewHolder holder, int position) {
